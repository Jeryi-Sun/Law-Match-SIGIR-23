...
def load_data():
    ...
    with open("/home/zhongxiang_sun/code/explanation_project/explanation_model/models_v2/data/GCI/civil/laws_clean.json", 'r') as f:
        laws_clean = json.load(f)

    """
    load wv
    """
    with open('/home/zhongxiang_sun/code/explanation_project/explanation_model/models_v2/data/GCI/civil/used_wv_civil.pkl', 'rb') as f:
        used_wv = pkl.load(f)
    ...
    """
    fact_clean_embedding = np.load("/home/zhongxiang_sun/code/explanation_project/explanation_model/models_v2/data/GCI/civil/fact_embedding_civil.npy", allow_pickle=True).tolist()
